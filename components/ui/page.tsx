...
function PageHeaderSubHeading({ className, ...props }: React.HTMLAttributes<HTMLParagraphElement>) {
  return (
    <p
      className={cn('max-w-[750px] text-center text-muted-foreground  text-pretty', className)}
      {...props}
    />
  );
}
...
export { PageActions, PageHeader, PageHeaderDescription, PageHeaderHeading, PageHeaderSubHeading };
